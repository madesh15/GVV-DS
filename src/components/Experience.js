  ...
  return (
    <section id="experience" style={{ background: '#09090f', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center', marginBottom: 80 }} className="exp-header">
          <div>
            ...
            <h2 style={{
              ...
              fontSize: 'clamp(36px,4vw,54px)', color: '#f5f0e4', lineHeight: 1.15,
            }}>
              The GVV<br />
              <em style={{ color: '#d4a636' }}>Difference</em>
            </h2>
          </div>
          ...
          <div>
            <p style={{
              ...
              fontSize: 16, color: 'rgba(245,240,228,0.75)', lineHeight: 1.85,
            }}>
              At GVV Driving School, we don't just teach you to drive — we build your confidence,
              road awareness, and life-long safe driving habits. Here's what sets us apart.
            </p>
            <div style={{ marginTop: 32, display: 'flex', gap: 40 }}>
              {[['10,000+', 'Students'], ['99%', 'Pass Rate'], ['15+', 'Years']].map(([v, l], i) => (
                <div key={i}>
                  <div style={{
                    fontFamily: "'Playfair Display', serif", fontWeight: 700,
                    fontSize: 36, color: '#d4a636', lineHeight: 1,
                  }}>{v}</div>
                  <div style={{
                    fontFamily: "'Barlow', sans-serif", fontSize: 11,
                    letterSpacing: 2, color: 'rgba(245,240,228,0.65)',
        ...
        <div style={{
          width: '100%', height: 1,
          background: 'linear-gradient(90deg, #d4a636, rgba(212,166,54,0.1))',
          marginBottom: 2,
        }} />
          ...
          {features.map((f, i) => (
            <div
              ...
              style={{
                ...
                borderLeft: i % 2 !== 0 ? '1px solid rgba(245,240,228,0.08)' : 'none',
                transition: 'background 0.3s ease',
              }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(212,166,54,0.05)'}
              onMouseLeave={e => e.currentTarget.style.background = 'rgba(13,13,13,0.02)'}
            >
              <div style={{ color: '#d4a636', marginBottom: 18 }}>{f.icon}</div>
              <h4 style={{
                fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700,
                fontSize: 18, color: '#f5f0e4', letterSpacing: 0.5, marginBottom: 10,
              }}>{f.title}</h4>
              <p style={{
                fontFamily: "'Barlow', sans-serif", fontWeight: 400,
                fontSize: 14, color: 'rgba(245,240,228,0.72)', lineHeight: 1.75,
              }}>{f.desc}</p>
            </div>
          ))}
        </div>
          ...
          <div style={{
            ...
            <div>
              <p style={{
                ...
                fontSize: 'clamp(22px,3vw,38px)', color: '#f5f0e4',
                lineHeight: 1.4, maxWidth: 700,
              }}>
                "The road to confidence begins with the right guide.
                GVV has been that guide for over 10,000+ students."
              </p>
              <div style={{
                marginTop: 20, fontFamily: "'Barlow', sans-serif",
                fontSize: 13, letterSpacing: 2, color: '#d4a636', textTransform: 'uppercase',
              }}>
                — G.V Devirajeshwari, Founder & Head Instructor
              </div>
            </div>
          </div>
        </div>
